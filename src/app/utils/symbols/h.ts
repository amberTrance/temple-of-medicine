...
const h: Symbol[] = [
  {
    ...
    citations: [
      {
        text: "So what is the beard? The hair which grows on the different parts of the body is reminiscent of our animal nature; it is the remains of the fur which we have lost and which most other animals still have. Hair evokes the idea of something primitive and instinctive and animal-like, but the meaning varies according to the part of the body on which the hair appears. The hair on the head carries the projection of unconscious involuntary thoughts and fantasies, because these grow out of our heads",
        author: "Marie-Louise von Franz",
        source: "The Feminine in Fairy Tales, p.144",
      },
    ],
  },
  {
